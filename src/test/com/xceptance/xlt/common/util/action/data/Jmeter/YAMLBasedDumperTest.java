...
import com.xceptance.xlt.common.util.action.data.Jmeter.YAMLBasedDumper;
...
public class YAMLBasedDumperTest {
    ...
    private final static String path = "./config/data/test/JmeterStuff/";
    private static String folderTmp = path + "/tmp/";	
    private static Path fileTmp = null;
	...
	public static void ensureTmpFolderNotExists() {
	    ...
	    fileTmp = Paths.get(folderTmp + "tmpFile.yml");
	}   
